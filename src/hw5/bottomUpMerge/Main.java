...
//same Main class as in hw3 and hw4
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		BottomUpMergeSort.sort(ipAddresses);
		
      System.out.println("Sorted. Time elapsed: " + ((System.currentTimeMillis() - start)/1000));
      //average sorting time: 4.2 seconds
      System.out.println("Writing to file...");

		FileWriter writer = new FileWriter("src/sortedwithbottomup.csv");
